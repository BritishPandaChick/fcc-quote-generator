$(document).ready(function () {
  ...
  $("#tweet-quote").click(function () {
    const textToTweet = '"' + $("text").text() + '"' + " " + $("#author").text();
    const tweetLink = 'https://twitter.com/intent/tweet?text=' + encodeURIComponent(textToTweet);
