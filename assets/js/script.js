$(document).ready(function () {
  ...
  function displayQuote() {
    var randomNumber = Math.floor((Math.random() * wisdom.length));
    // see element with text id
    var randomQuote = wisdom[randomNumber];
    // see element with author id 
    var randomAuthor = characters[randomNumber];
